...
public class Funcionario {
    ...
    public @NotBlank(message = "O CPF é obrigatório") @Size(max = 11, message = "O CPF deve ter no máximo 11 caracteres") String getCpf() {
        return cpf;
    }

    public void setCpf(@NotBlank(message = "O CPF é obrigatório") @Size(max = 11, message = "O CPF deve ter no máximo 11 caracteres") String cpf) {
        this.cpf = cpf;
    }
